...
//                        Log.e("orderInfo",buildPaymentParam());

//                        if (null != mIsSplitOrder) {
//                            if (!mIsSplitOrder.equals("0")) {
//                                paymentWithAlipay(buildPaymentParamOR());
//                            } else {
                        paymentWithAlipay(buildPaymentParam());
//                            }
//                        }
    ...
    public String buildPaymentParam() {
        ...
        orderInfo += "&notify_url=" + "\"" + ApiHelper.BASE_URL
                + "payment/gift_alipay_notify" + "\"";
...
//        mUnionPayText.setChecked(false);
    ...
    private class GetPrepayIdTask extends AsyncTask<Void, Void, Map<String, String>> {
        ...
        protected void onPreExecute() {
            dialog = ProgressDialog.show(CardOrderSubmitSuccessActivity.this, "提交申请", "正在处理中...");
        }
    ...
    private String genProductArgs() {
        ...
        try {
            ...
            packageParams.add(new BasicNameValuePair("notify_url", ApiHelper.BASE_URL + "payment/gift_wechat_notify"));//回调页面
