 ...
 */
public class EntityCardFragment extends BaseFragment implements EntityCardAdapter.OnItemClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        if (view == null) {
            ...
            mAdapter = new EntityCardAdapter(getContext(), mCardList);
    ...
    public void setRecRequest(int current_page) {
        if (current_page == 1) {
            MabaoCardApi.get_entity_card(1, listener);
        } else {
            MabaoCardApi.get_entity_card(page, listener);
        }
    }
