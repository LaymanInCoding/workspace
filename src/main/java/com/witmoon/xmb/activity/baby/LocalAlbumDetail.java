...
import com.witmoon.xmb.util.ExtraKey;
 ...
 * @date 2015-4-11
 */
public class LocalAlbumDetail extends Activity implements MatrixImageView.OnSingleTapListener, View.OnClickListener
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.header_finish:
                if(LocalAlbum.localAlbumActivity != null){
                    LocalAlbum.localAlbumActivity.finish();
                }
