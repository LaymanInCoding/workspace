...
public class LocalImageHelper {
    ...
    public String setCameraImgPath() {
        String foloder = AppContext.instance().getCachePath()
                + "/PostPicture/";
    ...
    public static Boolean check_permision(Activity activity){
        if (android.os.Build.VERSION.SDK_INT >= 23 && ContextCompat.checkSelfPermission(activity,
