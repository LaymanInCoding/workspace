...
public class TDevice {
    ...
    public static int getDefaultLoadFactor() {
        if (_loadFactor == null) {
            Integer integer = 0xf & BaseApplication.context().getResources().getConfiguration()
                    .screenLayout;
            _loadFactor = integer;
    ...
    public static boolean hasBigScreen() {
        ...
        if (_hasBigScreen == null) {
            boolean flag1;
            flag1 = (0xf & BaseApplication.context().getResources().getConfiguration()
                    .screenLayout) >= 3 && flag;
    ...
    public static boolean hasInternet() {
        return ((ConnectivityManager) BaseApplication.context().getSystemService(Context
    ...
    public static int getActionBarHeight(Context context) {
        int actionBarHeight = (int) context.getResources().getDimension(R.dimen
