...
import com.witmoon.xmb.presenter.MajorArticlePresenter;
...
public class MajorArticleActivity extends BaseActivity {
    ...
    MajorArticlePresenter mPresenter;
    ...
    public void setRecRequest(int currentPage){
        mPresenter.get_article_list(ArticleService.gen_article_list_params(page));
    }
    ...
    protected void initRecycleView(){
        ...
        mPresenter = new MajorArticlePresenter(this,mService);
        ...
        emptyLayout = (EmptyLayout)findViewById(R.id.error_layout);
        findViewById(R.id.search_textview).setOnClickListener((View v)->startActivity(new Intent(MajorArticleActivity.this,MajorArticleSearchActivity.class)));
        emptyLayout.setOnLayoutClickListener((View v)-> mPresenter.get_article_list(ArticleService.gen_article_list_params(page)));
        adapter.setOnItemClickListener((int position) -> {
                Intent intent = new Intent(MajorArticleActivity.this,MajorArticleDetailActivity.class);
