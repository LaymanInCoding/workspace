...
/**
 * 基于View的ToggleButton, 动画使用Facebook的Rebound动画库
 * github: https://github.com/zcweng/ToggleButton
 * rebound: http://facebook.github.io/rebound/
 * 作者Github: https://github.com/zcweng
 * Created by zhyh on 2015/5/10.
 */
public class ToggleButton extends View {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if(widthMode == MeasureSpec.UNSPECIFIED || widthMode == MeasureSpec.AT_MOST){
            widthSize = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 50, r
                    .getDisplayMetrics());
    ...
    private void calculateEffect(final double value) {
        final float mapToggleX = (float) SpringUtil.mapValueFromRangeToRange(value, 0, 1,
                spotMinX, spotMaxX);
        spotX = mapToggleX;
