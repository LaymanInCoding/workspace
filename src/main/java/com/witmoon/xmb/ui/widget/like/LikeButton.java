package com.witmoon.xmb.ui.widget.like;
...
public class LikeButton extends FrameLayout implements View.OnClickListener {
    ...
    public void onClick(View v) {
        if (AppContext.isNetworkAvailable(getContext())) {
            ...
            Toast.makeText(getContext(), "当前网络不可用", Toast.LENGTH_LONG).show();
        }
    }
    /**
    ...
    public void setEffectsViewSize() {
        if (iconSize != 0) {
            dotsView.setSize(iconSize * 2 -iconSize/2, iconSize * 2-iconSize/2);
